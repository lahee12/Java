...
public class List_3 {
    public static void main(String[] args) {
        ...
        aList3.remove(Integer.valueOf(2)); // Integer 로 타입변환
        System.out.println(aList3); // [1, 6]
        // #8. clear 모두 삭제
        aList3.clear();
        System.out.println(aList3); // []
        // #9. isEmpty 요소가 있는지 없는지 확인할때 사용. 비었으면 true 리턴
        ...
        // Object 의 약한(느슨한) 타입체크로 인해 정상동작을 담보할 수 없음
        ...
        // new Integer[0]는 0의 length  를 가진 배열을 만드는게 아니라
